...
4. Build inside the accepted scope.
5. Log notable work.
6. Check the result with the allowed verification commands.
7. Reflect before finishing.
8. Ask before adopting durable memory or broad scaffold rule changes.
